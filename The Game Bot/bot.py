...
async def fandom(ctx, option: str):
    if option == 'Blaze276':
        ...
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1118509756492021802/1162735257074794536/7583a56c23b85a3f32d91e89e17c5838.png?ex=653d0497&is=652a8f97&hm=5702135695dd02d07f185386782af9251c96fe5bb5f2e167fca9053afee0e6ce&")
        await ctx.send(embed=embed)
    else:
...
async def cleanse(ctx):
    Bl8ze="Bl8ze360"
    penguin="p1820"
    almond="kooliadmanvsgodzillawithagun"
    if ctx.author.guild_permissions.administrator:
        await ctx.send("banning <@1018339678484713522>, <@1033465604302188699>, and <@1044740815743897730>")
        msg = await ctx.send("cleansing Gaming To The People.")
        await asyncio.sleep(1)
        await msg.edit(content="cleansing Gaming To The People..")
        await asyncio.sleep(1)
        await msg.edit(content="cleansing Gaming To The People...")
        await asyncio.sleep(1)
        await msg.edit(content="cleansing Gaming To The People.")
        ...
        await msg.edit(content="cleansing Gaming To The People...")
        await asyncio.sleep(1)
        await ctx.send("Cleansed Gaming To The People")
        await asyncio.sleep(1)
        await Bl8ze.send(f'You have been banned from {ctx.guild.name} for the following reason: Gaming to the people has been cleansed of rippels...')
        await asyncio.sleep(5)
        await Bl8ze.ban(reason="Gaming to the people has been cleansed of rippels...")
        await asyncio.sleep(1)
        await penguin.send(f'You have been kicked from {ctx.guild.name} for the following reason: Gaming to the people has been cleansed of rippels...')
        await asyncio.sleep(5)
        await penguin.kick(reason="Gaming to the people has been cleansed of rippels...")
        await asyncio.sleep(1)
        await almond.send(f'You have been banned from {ctx.guild.name} for the following reason: Gaming to the people has been cleansed of rippels...')
        await asyncio.sleep(5)
        await almond.ban(reason="Gaming to the people has been cleansed of rippels...")
        await ctx.send(f'{Bl8ze}, {penguin}, and {almond} been banned for Gaming to the people has been cleansed of rippels...')
        print(f'Someone ran the command ?cleanse')
    else:
        await ctx.send("You don't have the necessary permissions to use this command.")
